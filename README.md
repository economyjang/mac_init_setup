...
### 셸 · 앱 설정
- `.zshrc` 생성 (Homebrew / pyenv / fnm / yarn / eza alias / zoxide / starship / fzf / zsh 자동완성(`compinit`) / git 커스텀 함수 / Claude Code · PostgreSQL PATH)
- git 전역 alias (`co`, `br`, `st`) 등록 — `git co <TAB>` 브랜치 자동완성용
